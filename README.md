...
2. **퀴즈 생성** 탭:
   - 상단에 학년별 배포 현황 카드 (중1/중2/중3 각각 어떤 퀴즈가 배포 중인지 표시)
   - 학년 선택 → 단원 선택 → 문제 수 / 난이도 / 객관식 비율 설정
   - **문제 생성하기** 클릭 → 미리보기에서 문제 확인
   - **배포하기** 클릭 → 해당 학년 학생들이 풀 수 있는 상태가 됨 (학년별 독립 배포)
3. **배포 문제** 탭:
   - 중1/중2/중3 버튼으로 학년 선택 → 현재 배포된 문제 전체 확인 (정답/해설 포함)
4. **결과 보기** 탭 (Google Sheets 연동 시):
   - 학년/단원 필터로 결과 필터링
   - 학생별 점수, 정답률, 오답 문제 확인
